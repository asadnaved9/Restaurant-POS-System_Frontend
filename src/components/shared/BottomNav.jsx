...
const BottonNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
        ...
        <button onClick={() => navigate("/table")} className='flex items-center justify-center text-[#ababab] w-[200px]'><MdTableBar className="inline mr-2" size={20} /> <p>Table</p></button>
        ...
        <button className="absolute bottom-6 bg-[#F6B100] text-[#f5f5f5] rounded-full p-4 items-center"><BiSolidDish size={30} /> </button>
    </div>
  )
}
